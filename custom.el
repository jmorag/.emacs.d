 ...
 '(safe-local-variable-values
   '((lsp-haskell-server-path . "ghcide")
     (eval add-hook 'before-save-hook
           ...
           nil t)
     (dante-repl-command-line "nix-shell" "--pure" "--run" "cabal repl test --builddir=dist/dante")
     (dante-repl-command-line "nix-shell" "--run" "cabal repl yesod --builddir=dist/dante")
     (dante-repl-command-line "nix-shell" "--run" "cabal repl shakespeare  --builddir=dist/dante")
     (dante-repl-command-line "nix-shell" "--run" "cabal repl yesod-core --builddir=dist/dante")
     (dante-repl-command-line "nix-shell" "--run" "cabal repl yesod-code --builddir=dist/dante")
     (dante-repl-command-line "cabal repl yesod-code --builddir=dist/dante")
     (dante-repl-command-line "cabal repl shakespeare  --builddir=dist/dante")
     (dante-repl-command-line "nix-shell" "--pure" "--run" "cabal repl shakespeare  --builddir=dist/dante")
